...
![GCC](https://img.shields.io/badge/GCC-Compiler-success?style=for-the-badge)
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Andris-Siravs-Dev&show_icons=true&theme=dark&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Andris-Siravs-Dev&layout=compact&theme=dark&hide_border=true)
...
| Feature | Python 🐍 | C ⚙️ | My Realization 💭 |
|---------|-----------|------|-------------------|
| **Typing** | 🔄 Dynamic | 📝 Static | *Everything must be declared!* |
| **Memory** | 🗑️ Automatic (GC) | 🧠 Manual | *I control EVERYTHING now* |
| **Abstraction** | 🚀 High-level | ⚙️ Low-level | *This is how computers REALLY work!* |
| **Speed** | 🐢 Slower | ⚡ Lightning fast | *So. Much. Faster.* |
| **Learning Curve** | 📈 Gentle | 📈📈📈 Steep | *But SO rewarding!* |
...
- 🌍 **Learning together:** If you're learning C too, let's connect! 🚀
...
> *"It's never too early to start coding, and you're never too young to change the world."*  
> — Me (while learning C) 💪
...
- 🍓 I develop on a **Raspberry Pi 4B** (not a fancy Mac!)
- 🐍 Started with Python, but C grabbed my heart
- 📚 I'm reading the **original K&R book** (1988 edition is still relevant!)
- 💪 Learning C at 14 to understand computers better
- 🌟 Believe that **anyone can learn to code**, no matter the age!

---

<div align="center">

### ⭐ If my K&R journey inspires you, feel free to star my repos! It means the world! ⭐
